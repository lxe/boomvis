...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div 
      className="w-80 bg-slate-800 p-4 overflow-y-auto flex flex-col transition-transform duration-300 ease-in-out translate-x-0 h-full"
    >
      {/* Main content */}
      <div className="flex-grow">
        ...
        <div className="space-y-4">
          <div className="bg-slate-700 p-3 rounded-lg shadow-md space-y-2">
            <ParameterControl
              label="Gain"
      ...
      <div className="text-xs text-gray-400">
        ...
        <div className="mt-2">
          ...
          <a 
            href="https://github.com/lxe/boomvis" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-blue-400 hover:text-blue-300"
          >
